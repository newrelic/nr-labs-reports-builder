export const UI_CONTENT = {
  ...
  HELP_MODAL: {
    ABOUT: {
      appName: 'New Relic Reports Builder',
      blurb:
        'Build and manage reports that run on the New Relic Reports engine.',
      moreInfo: {
        link: 'https://github.com/newrelic/nr-labs-reports-builder?tab=readme-ov-file#new-relic-reports-builder',
        text: 'Find out more',
      },
    },
    URLS: {
      docs: 'https://github.com/newrelic/nr-labs-reports-builder?tab=readme-ov-file#new-relic-reports-builder',
      createIssue:
        'https://github.com/newrelic/nr-labs-reports-builder/issues/new?labels=bug&template=bug_report.md',
      createFeature:
        'https://github.com/newrelic/nr-labs-reports-builder/issues/new?labels=enhancement&template=enhancement.md',
      createQuestion:
        'https://github.com/newrelic/nr-labs-reports-builder/discussions',
    },
    OWNER_BADGE: {
      logo: {
      ...
      blurb: {
        text: 'New Relic Reports Builder is an open source app created and maintained by the New Relic Labs team.',
      },
    },
  },
