...
export default function PublishConfigForm({ selectedConfig }) {
  const { formState, updateFormState } = useContext(FormContext),
    ...
    handleChangeConfigRef = useCallback(
      (_, v) => {
          ...
          metaPublishConfigs?.publishConfigs.length > 0 && (
            <StackItem>
              ...
              >
                <Radio
                  label={
                    UI_CONTENT.EDIT_SCHEDULE_FORM
                      .FIELD_LABEL_CREATE_NEW_SCHEDULE
                  }
                  value={
                    UI_CONTENT.EDIT_SCHEDULE_FORM.MODE_VALUE_CREATE_NEW_SCHEDULE
                  }
                ...
                <Radio
                  label={
                    UI_CONTENT.EDIT_SCHEDULE_FORM
                      .FIELD_LABEL_USE_EXISTING_SCHEDULE
                  }
                  value={
                    UI_CONTENT.EDIT_SCHEDULE_FORM
                      .MODE_VALUE_USE_EXISTING_SCHEDULE
                  }
                />
              </RadioGroup>
            </StackItem>
      ...
      {selectedConfig === -1 &&
        ...
        metaPublishConfigs.publishConfigs.length > 0 && (
          <StackItem>
            ...
            >
              {metaPublishConfigs.publishConfigs.map((item, index) => (
