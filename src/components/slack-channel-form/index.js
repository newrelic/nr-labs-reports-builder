...
import { Stack, StackItem, TextField } from 'nr1'
...
export default function SlackChannelForm({ onChangeWebhookUrl }) {
  const { formState } = useContext(FormContext),
    { slackWebhookUrl, validations } = formState
      ...
      <StackItem>
        ...
        >
          <TextField
            ...
            placeholder={
              UI_CONTENT.SLACK_CHANNEL_FORM.WEBHOOK_URL_FIELD_PLACEHOLDER
            }
...
SlackChannelForm.propTypes = {
  onChangeWebhookUrl: PropTypes.func,
}
