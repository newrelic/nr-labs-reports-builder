...
export default function ChannelForm({ selectedChannel }) {
  const { formState, updateFormState } = useContext(FormContext),
    ...
    handleChangeChannelRef = useCallback(
      (_, v) => {
          ...
          metaChannels?.channels.length > 0 && (
            <StackItem>
              ...
              >
                <Radio
                  label={
                    UI_CONTENT.EDIT_CHANNEL_FORM.FIELD_LABEL_CREATE_NEW_CHANNEL
                  }
                  value={
                    UI_CONTENT.EDIT_CHANNEL_FORM.MODE_VALUE_CREATE_NEW_CHANNEL
                  }
                ...
                <Radio
                  label={
                    UI_CONTENT.EDIT_CHANNEL_FORM
                      .FIELD_LABEL_USE_EXISTING_CHANNEL
                  }
                  value={
            ...
            {formState.type === SYMBOLS.CHANNEL_TYPES.EMAIL && (
              <EmailChannelForm
                ...
                onChangeQueryResultsHtmlMaxRows={
                  handleChangeQueryResultsHtmlMaxRows
                }
        ...
        metaChannels.channels.length > 0 && (
          <>
            <StackItem>
              ...
              >
                {metaChannels.channels.map((item, index) => (
