...
export const reportTypeIsValid = (() => {
  ...
  return (formState) => {
    ...
    return result.success
      ? null
      : `${formState.type} is not a valid report type`
  }
})()
...
export const accountIdsNotEmptyValidNumbers = (() => {
  ...
  return (formState) => {
    ...
    return result.success
      ? null
      : 'At least one and at most 5 account IDs required'
  }
})()
...
export const channelTypeIsValid = (() => {
  ...
  return (formState) => {
    ...
    return result.success
      ? null
      : `${formState.type} is not a valid channel type`
  }
})()
...
export const emailFormatIsValid = (() => {
  ...
  return (formState) => {
    ...
    return result.success
      ? null
      : `${formState.emailFormat} is not a valid email format`
  }
})()
...
export const emailToNotEmptyValidEmails = (() => {
  ...
  return (formState) => {
    ...
    return result.success
      ? null
      : 'One or more valid email addresses are required. Separate multiple email addresses with a new line.'
  }
})()
...
export const emailCcValidEmails = (() => {
  ...
  return (formState) => {
    if (formState.emailCc.length > 0) {
      ...
      return result.success
        ? null
        : 'Only valid email addresses are allowed. Separate multiple email addresses with a new line.'
    }
